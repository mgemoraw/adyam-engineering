...
const HomePage = () => {
  ...
  const { contacts, loading, error, loadContacts, clearError } =
    useContactStore();
    ...
    <div className={`home-page ${theme}`}>
      ...
      <section className="hero-section relative overflow-hidden">
        <video
          ...
          muted
          playsInline
          className="hero-video-bg absolute top-0 left-0 w-full h-full object-cover opacity-50 object-center z-0 pointer-events-none "
          // style={{
          //   position: "absolute",
          //   top: 0,
          //   left: 0,
      ...
      <section className="about-section">
        <div className="about-image">
          ...
          <img
            src="https://cdn.prod.website-files.com/62196607bf1b46c300301846/6568adc6401542df279ea6c3_bb8sa1slxdbdyjqqb5mn.webp"
            alt="Our Team"
          />
        </div>
        <div className="about-content">
          <h2 className="text-center font-bold text-sky-800">
            {t("home.aboutTitle")}
          </h2>
          ...
          <ul className="about-features">
            <h3 className="text-left text-xl font-bold pb-3 text-sky-800">
              Features
            </h3>
            <li>
